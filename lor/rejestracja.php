    ...
    session_start();
		...
		if(isset($_POST['email']))
			
			{
				...
				//Captcha
				$captcha="6LdJ15QUAAAAAE7GOOECLyV6ZETxHMjqWZYdLFlk";
...
<head>
  ...
  <title>LOR - zakładanie konta!</title>
...
<body>
    ...
    <form method="post">
	    ...
	    <div class="g-recaptcha" data-sitekey="6LdJ15QUAAAAAGXzgqrGrycOAxvBtRL-0cJqjLq8"></div>
		<br />
